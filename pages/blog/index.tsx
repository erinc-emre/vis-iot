          ...
          <Grid item md={8}>
            ...
            >
              ...
              <Typography variant="h5" color="#e0e0e0" paragraph>
                A blog where the development process of VISIOT is shared on a
                weekly basis. I am writing the information I learned and the
                difficulties I encountered during the development of the
                project.
              </Typography>
            </Box>
          </Grid>
        ...
        {allPostsData.map(({ id, date, title, cover, description }: any) => (
          ...
          >
            <Link href={'/blog/' + id}>
              ...
              >
                <CardMedia component="img" image={cover} alt="cover" />
