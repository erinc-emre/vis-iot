...
import iBackground from '../public/homePage/homePage_1.jpg';
  ...
  return (
    ...
    <Container maxWidth="lg">
      <Box sx={{my: 4, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center',}}>
        ...
        <Typography sx={{mt:6}} variant="h1" align="center" color="text.primary" gutterBottom>
          VISIOT
        </Typography>

        <Typography variant="h5" align="center" color="text.secondary" paragraph maxWidth="md" sx={{mt:2}}>
        Accelerate your projects with the perfect combination of Image Processing and IoT. VISIOT is a highend IoT management platform for industrial and individual use.</Typography>
